...
<section class="header">
    ...
    <div class="text-center">
        <h2 class="medium text-white mt-3">Pengajuan Startup</h2>
        <p class="italic text-white mb-5">Ayo Ajukan Startup Anda Sekarang</p>
    </div>
...
<div class="row justify-content-center">
    <div class="col-lg-6 col-10 col">
        <div class="content shadow">
            ...
            <div class="card mb-3">Tulis Pengajuan Disini</div>
            <form action="{{ route('pekat.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="form-group">
                    <input type="text" value="{{ old('judul_laporan') }}" name="judul_laporan"
                        placeholder="Masukkan Nama Startup" class="form-control">
                </div>
                <div class="form-group">
                    <textarea name="isi_laporan" placeholder="Masukkan Deskripsi Startup" class="form-control"
                        rows="4">{{ old('isi_laporan') }}</textarea>
                </div>
                <div class="form-group">
                    <input type="text" value="{{ old('tgl_kejadian') }}" name="tgl_kejadian"
                        placeholder="Pilih Tanggal Pengajuan" class="form-control" onfocusin="(this.type='date')"
                        onfocusout="(this.type='text')">
                </div>
                <div class="form-group">
                    <textarea name="lokasi_kejadian" id="latlang" rows="3" class="form-control mb-3"
                        placeholder="Masukkan Harapan Untuk Startup Anda Kedepannya (*Sertakan Link Deck Startup Anda Jika Ada)">{{ old('lokasi_kejadian') }}</textarea>
                </div>
                <div class="form-group">
