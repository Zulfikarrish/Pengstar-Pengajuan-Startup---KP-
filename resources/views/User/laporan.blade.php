...
@section('title', 'PENGSTAR - Pengajuan Startup')
        ...
        <div class="container">
            <div class="container-fluid">
                <a class="navbar-brand" href="{{ route('pekat.index') }}">
                    <h4 class="semi-bold mb-0 text-white">PENGSTAR • IndigoHub Makassar</h4>
                    <p class="italic mt-0 text-white">Pengajuan Startup</p>
                </a>
    ...
    <div class="row justify-content-between">
        <div class="col-lg-8 col-md-12 col-sm-12 col-12 col">
            <div class="content content-top shadow">
                ...
                @endif
                <div class="card mb-3">Isi Form Pengajuan Disini</div>
                <form action="{{ route('pekat.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="form-group">
                        <input type="text" value="{{ old('judul_laporan') }}" name="judul_laporan" placeholder="Nama Startup"
                            class="form-control">
                    </div>
                    <div class="form-group">
                        <textarea name="isi_laporan" placeholder="Deskripsi Startup" class="form-control"
                            rows="4">{{ old('isi_laporan') }}</textarea>
                    </div>
                    <div class="form-group">
                        <input type="text" value="{{ old('tgl_kejadian') }}" name="tgl_kejadian" placeholder="Pilih Tanggal Pengajuan" class="form-control"
                            onfocusin="(this.type='date')" onfocusout="(this.type='text')">
                    </div>
                    <div class="form-group">
                        <textarea name="lokasi_kejadian" rows="3" class="form-control" placeholder="Masukkan Harapan Untuk Startup Anda Kedepannya (*Sertakan Link Deck Startup Anda Jika Ada)">{{ old('lokasi_kejadian') }}</textarea>
                    </div>
                    <div class="form-group">
                        <div class="input-group mb-3">
                            <select name="kategori_kejadian" class="custom-select" id="inputGroupSelect01" required>
                                <option value="" selected>Pilih Kategori Startup</option>
                                <option value="Games dan Entertaiment">Games dan Entertaiment</option>
            ...
            <div class="content content-bottom shadow">
                <div>
                    ...
                    <div class="row text-center">
                        <div class="col">
                            <p class="italic mb-0">Gagal Seleksi</p>
                            <div class="text-center">
                                {{ $hitung[1] }}
                            </div>
                        </div>
                        <div class="col">
                            <p class="italic mb-0">Sedang Diproses</p>
                            <div class="text-center">
                                {{ $hitung[0] }}
                            </div>
                        </div>
                        <div class="col">
                            <p class="italic mb-0">Lulus Seleksi</p>
                            <div class="text-center">
                                {{ $hitung[2] }}
                            </div>
                        </div>
            ...
            <div class="laporan-top">
                ...
                <div class="d-flex justify-content-between">
                    <div>
                        <p>{{ $v->user->nama }}</p>
                        @if ($v->status == '0')
                        <p class="text-danger">Sedang Diproses</p>
...
<div class="mt-5">
    <hr>
    <div class="text-center">
        <p class="italic text-secondary">© 2023 Aplikasi Pengajuan Startup • IndigoHub Makassar</p>
    </div>
</div>
@endsection
